...
function CorrectQuestion({question, options, index, id}) {
    const questionState = useSelector((state) => state)
  return (
    <div className='py-3 px-4 bg-green-200 mb-3'> 
            {/* question */}
            <div>
            ...
            <div className=''>
                ...
                <p className='pl-5'>
                    localhostlocalhostlocalhostlocalhostlocalhostlocalhostlocalhostlocalhost localhostlocalhostlocalhostlocalhostlocalhostlocalhostlocalhostlocalhost localhostlocalhostlocalhostlocalhostlocalhostlocalhostlocalhost
                </p>
            </div>  
        </div>
  )
