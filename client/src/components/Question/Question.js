                    ...
                    <div className='flex space-x-3 items-center'>
                        {
                            questionState[id] == option?(
                                ...
                                <input type="radio" name={index} id={index} value = {index} checked className="w-6 h-6" onChange={()=>dispatch(add({id, option}))} />
                            ):(
                                <input type="radio" name={index} id={index} value = {index} className="w-6 h-6" onChange={()=>dispatch(add({id, option}))} />
                            )
                        }   
